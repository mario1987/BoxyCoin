    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Boxy version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  boxycoind [options]                     " + "\n" +
                  "  boxycoind [options] <command> [params]  " + _("Send command to -server or boxycoind") + "\n" +
                  "  boxycoind [options] help                " + _("List commands") + "\n" +
                  "  boxycoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: boxy.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: boxycoind.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 21524 or testnet: 121524)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 21523 or testnet: 121523)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Boxy Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // 1-boxoshi-fee transactions. It should be set above the real
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Boxy is probably already running."), strDataDir.c_str()));

    if (GetBoolArg("-shrinkdebugfile", !fDebug))
        ShrinkDebugFile();
    printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    printf("Boxy version %s (%s)\n", FormatFullVersion().c_str(), CLIENT_DATE.c_str());
