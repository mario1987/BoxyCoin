...
// Copyright (c) 2014 -2014 DigiByte (DigiShield Developers).
...
#if defined(NDEBUG)
# error "Boxy cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xd880c4e8db4427c936d8c759b463102694366b3e2e512f7b62a946c0d39d50dd");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Boxy: starting difficulty is 1 / 2^12
...
/** Fees smaller than this (in boxoshi) are considered zero fee (for transaction creation) */
int64 CTransaction::nMinTxFee = 100000;
/** Fees smaller than this (in boxoshi) are considered zero fee (for relaying) */
...
{
    // Boxy: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nDiffChangeTarget = 30500; // Patch effective @ block 30500
...
int64 GetBlockValue(int nHeight, int64 nFees)
{
    int64 nSubsidy = 30 * COIN;
            ...
            if(nHeight == 2)
            {
            nSubsidy = 3333333 * COIN;
            }
    // Boxy has an allocation of 3% for adoption/bounties/rewards and 0.3333% for BOXY and ARTAX development
    // Premine is broadcasted on the Boxycoin public ledger, please see our official forums for more information
    // There is no dev premine and by way of mutual decision, official pools will not be broadcasted until Block 1000
    // Subsidy is cut in half every 900000 blocks
    nSubsidy >>= (nHeight / 900000); // Boxy: 900k blocks 

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 20 * 10; // old Boxy retarget: 20 minutes
static const int64 nTargetTimespanNEW = 65 ; // Boxy: every 65 seconds
static const int64 nTargetSpacing = 1 * 65; // Boxy: 65 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Boxy: This fixes an issue where a 51% attack can change difficulty at will.
    ...
    if(fNewDifficultyProtocol) //DigiShield implementation - thanks to RealSolid & WDC for this code Re:Dogecoin
    {
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Boxy: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd880c4e8db4427c936d8c759b463102694366b3e2e512f7b62a946c0d39d50dd");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        //nTime: 1510723234 
        //nNonce: 1572978  
        //vMerkleTree: cbbd3ac705fc543c0a61193ab593d9abecdf8abdfe8695cfb017232982b0bb26
        ...
        block.nVersion = 1;
        block.nTime    = 1510723234;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1572978;
        ...
        assert(block.hashMerkleRoot == uint256("0xcbbd3ac705fc543c0a61193ab593d9abecdf8abdfe8695cfb017232982b0bb26"));
...
unsigned char pchMessageStart[4] = { 0xc3, 0xc1, 0xb2, 0xdb }; // Boxy: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BoxyMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BoxyMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static BoxyMiner(CWallet *pwallet)
{
    printf("BoxyMiner started\n");
    ...
    try { loop {
        ...
        printf("Running BoxyMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&BoxyMiner, pwallet));
}
